...
save_path = f'Resnet50_weights/{dataset_name}/{model_name}_{save_path_time}_Net.pth'
...
filename = f"Resnet50_results/{dataset_name}/training_results_{model_name}_{result_time}.txt"
...
plt.legend()
plt.tight_layout()
plt.savefig(f"Resnet50_results/{dataset_name}/Accuracy & AUC_{model_name}_{save_path_time}.png")  # Save to host server
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(f"Resnet50_results/{dataset_name}/Sensitivity and specificity_{model_name}_{save_path_time}.png")  # Save to host server
plt.close()
...
plt.tight_layout()
plt.legend()
plt.savefig(f"Resnet50_results/{dataset_name}/Loss & F1_{model_name}_{save_path_time}.png")  # Save to host server
plt.close()
